## Usage
1. Download the latest release from https://github.com/Skidscripter/Roblox-fps-unlocker
...
Before [submitting an issue](https://github.com/Skidscripter/Roblox-fps-unlocker/issues), please:
